...
if($result)
{
    if(mysqli_num_rows($result)>=1)
    {
        ...
        <a href="user/dashboard.php" >Check All Bookings Here <i data-feather="chevron-right" class="inline"></i></a>
        </div>';
            ...
            <div class="setion-2 p-2 bg-white rounded-md my-4">
                ...
                <div class="sec-2-sub px-4 py-2 flex gap-4">
                    ...
                    <div class="text-all-sise">
                        ...
                        <input name="mobile-no" type="text" class="border-2 rounded-md px-3 py-2 sm:w-100" placeholder="10 digit number" maxlength="10" required>
                    </div>
                </div>
            </div>
        <!--section 3 -->

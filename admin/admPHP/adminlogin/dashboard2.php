...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['approve'])) {
        ...
        $sql = "UPDATE bookings2 SET status='Approved' WHERE b_id='$bookingId'";
        ...
        $bookingId = $_POST['booking_id'];
        $sql = "UPDATE bookings2 SET status='Rejected' WHERE b_id='$bookingId'";
        mysqli_query($conn, $sql);
        // Redirect back to dashboard
        header("Location: dashboard1.php");
        exit();
...
$sql = "SELECT b_id, b_date, b_time, b_booker_name, b_reason status FROM bookings2 WHERE status='Pending'";
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="bg-gray-800 text-gray-100 w-full h-screen md:w-64 flex-shrink-0">
            <div class="p-4">
                ...
                <ul class="mt-4">
                    <li class="py-2 hover:bg-gray-700"><a href="C:\xampp\htdocs\cutmap gallaryhall booking\cutmap gallaryhall booking\admin\admPHP\managebooking.html" class="block px-4"></a></li>
                    <li class="py-2 hover:bg-gray-700"><a href="dashboard1.php" class="block px-4">Gallery  Hall 1</a></li>
        ...
        <div class="w-full px-4 py-8">
            <h2 class="text-2xl font-bold mb-4">Gallery Hall 2</h2>
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td class='py-2 border'>" . $row['b_time'] . "</td>";
                                echo "<td class='py-2 border'>" . $row['b_booker_name'] . "</td>";
